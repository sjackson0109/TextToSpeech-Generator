                ...
                New-GroupBox -Header "TTS Provider Selection" -Foreground White -Margin "0,0,0,12" -Content {
                    New-StackPanel -Children {
                        New-Grid -Margin 8 -ColumnDefinitions @(180,"*",110,110) -Children {
                            New-Label -Content "Provider:" -GridColumn 0 -VerticalAlignment centre -Foreground White
                            New-ComboBox -Name "ProviderSelect" -GridColumn 1 -Height 25 -Margin "5,2" -VerticalAlignment centre -Items @("Azure","AWS","Google","Twilio","VoiceForge","VoiceWave")
                            New-Button -Content "Refresh" -GridColumn 2 -Height 25 -Margin "5,2" -VerticalAlignment centre
                            New-Button -Content "Setup" -GridColumn 3 -Height 25 -Margin "5,2" -VerticalAlignment centre
                        }
                    }
                }
