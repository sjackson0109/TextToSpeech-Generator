...
"@
        ...
        [object]initialiseModernGUI($Profile = "Default", $ConfigurationManager = $null) {
                ...
                try {
                        ...
                        # Create the window if it does not exist or is not a WPF window
                        ...
                        # Validate the window and handle failures
                        if ($null -eq $this.Window -or $this.Window.GetType().FullName -ne 'System.Windows.Window') {
                        ...
                        # Populate provider dropdown if necessary
                        ...
                        # If the window is already visible, hide it before showing to avoid errors
                        ...
                        # Show the window (load it if not loaded)
                        $this.WriteSafeLog("DEBUG: Showing window via ShowDialog", "DEBUG")
        ...
        [void]WriteSafeLog($Message, $Level = "INFO") {
                ...
                if (Get-Command Add-ApplicationLog -Module "GUI" -ErrorAction SilentlyContinue) {
                        Add-ApplicationLog -Module "GUI" -Message $Message -Level $Level
                } else {
