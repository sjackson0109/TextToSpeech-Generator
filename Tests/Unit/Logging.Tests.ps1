...
Describe "Logging Module Tests" {
    ...
    Context "Basic Logging Functions" {
        It "Should write INFO level messages" {
            Write-ApplicationLog -Module "Logging.Tests" -Message "Test INFO message" -Level "INFO" -Category "Testing"
        ...
        It "Should write DEBUG level messages" {
            Write-ApplicationLog -Module "Logging.Tests" -Message "Test DEBUG message" -Level "DEBUG" -Category "Testing"
        ...
        It "Should write ERROR level messages" {
            Write-ApplicationLog -Module "Logging.Tests" -Message "Test ERROR message" -Level "ERROR" -Category "Testing"
        ...
        It "Should respect log level filtering" {
            ...
            Write-ApplicationLog -Module "Logging.Tests" -Message "Should not appear" -Level "DEBUG" -Category "Testing"
            Write-ApplicationLog -Module "Logging.Tests" -Message "Should appear" -Level "WARNING" -Category "Testing"
    ...
    Context "Log Message Structure" {
        It "Should include timestamp in log entries" {
            Write-ApplicationLog -Module "Logging.Tests" -Message "Timestamp test" -Level "INFO" -Category "Testing"
        ...
        It "Should include category in log entries" {
            Write-ApplicationLog -Module "Logging.Tests" -Message "Category test" -Level "INFO" -Category "SpecialCategory"
        ...
        It "Should handle properties in log entries" {
            ...
            Write-ApplicationLog -Module "Logging.Tests" -Message "Properties test" -Level "INFO" -Category "Testing" -Properties $properties
    ...
    Context "Log Performance" {
        It "Should write logs efficiently" {
            ...
            for ($i = 0; $i -lt 100; $i++) {
                Write-ApplicationLog -Module "Logging.Tests" -Message "Performance test message $i" -Level "INFO" -Category "Performance"
            }
        ...
        It "Should handle large log messages" {
            ...
            { Write-ApplicationLog -Module "Logging.Tests" -Message $largeMessage -Level "INFO" -Category "Testing" } | Should -Not -Throw
    ...
    Context "Log Rotation" {
        It "Should handle log rotation when size limit reached" {
            ...
            for ($i = 0; $i -lt 50; $i++) {
                Write-ApplicationLog -Module "Logging.Tests" -Message "Rotation test message $i with extra content to increase size" -Level "INFO" -Category "Rotation"
            }
            
            # Should not throw errors even if rotation occurs
            { Write-ApplicationLog -Module "Logging.Tests" -Message "After rotation" -Level "INFO" -Category "Rotation" } | Should -Not -Throw
        }
    }
    ...
    Context "Error Handling" {
        It "Should handle invalid log levels gracefully" {
            ...
            { Write-ApplicationLog -Module "Logging.Tests" -Message "Invalid level test" -Level "INVALID" -Category "Testing" } | Should -Not -Throw
        }
        
        It "Should handle null or empty messages" {
            { Write-ApplicationLog -Module "Logging.Tests" -Message "" -Level "INFO" -Category "Testing" } | Should -Not -Throw
            { Write-ApplicationLog -Module "Logging.Tests" -Message $null -Level "INFO" -Category "Testing" } | Should -Not -Throw
        }
        ...
        It "Should continue working after file access errors" {
            ...
            { Write-ApplicationLog -Module "Logging.Tests" -Message "After error test" -Level "INFO" -Category "Testing" } | Should -Not -Throw
        }
    }
        ...
        It "Should handle concurrent log writes" {
            $jobs = 1..5 | ForEach-Object {
                Start-Job -ScriptBlock {
                    ...
                    for ($i = 0; $i -lt 20; $i++) {
                            Write-ApplicationLog -Module "Logging.Tests" -Message "Thread $ThreadId message $i" -Level "INFO" -Category "Concurrency"
                        Start-Sleep -Milliseconds 10
                    }
                } -ArgumentList "$PSScriptRoot\..\..\Modules\Logging.psm1", $script:TestLogPath, $_
            }
